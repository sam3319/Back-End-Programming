MVC 패턴은 소프트웨어 개발에서 가장 널리 사용되는 디자인 패턴 중 하나로, 애플리케이션을 **Model**, **View**, **Controller**라는 세 가지 구성 요소로 분리하여 개발하는 아키텍처 패턴. 이 패턴은 사용자 인터페이스, 데이터, 논리 제어를 구현하는데 사용되며, 소프트웨어의 비즈니스 로직과 화면을 구분하는데 중점을 두고 있다.
